...
export default async function decorate(block) {
  ...
  const offerpath = '/content/dam/securbank/en/offers/997';
...
*/
const url = 'https://publish-p99452-e916802.adobeaemcloud.com/graphql/execute.json/securbank/OfferByPath;path=/content/dam/securbank/en/offers/997;variation=main'
